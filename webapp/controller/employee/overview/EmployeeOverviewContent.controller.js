sap.ui.define([
	...
	"sap/ui/model/Sorter"
		...
		"use strict";
		return BaseController.extend("UI5RoutingExample.controller.employee.overview.EmployeeOverviewContent", {
			onInit: function () {
			...
			onSearchEmployeesTable : function (oEvent) {
				// var sQuery = oEvent.getSource().getValue(); OLD
				// this._applySearchFilter( oEvent.getSource().getValue() ); OLD
				var oRouter = this.getRouter();
			...
			_initViewSettingsDialog : function () {
				...
				this._oVSD = new sap.m.ViewSettingsDialog("vsd", {
					confirm: function (oEvent) {
						...
						//this._applySorter(oSortItem.getKey(), oEvent.getParameter("sortDescending")); OLD
					}.bind(this),
				...
				this._oVSD.addSortItem(new sap.m.ViewSettingsItem({
					key: "EmployeeID",
					text: "Employee ID",
					selected: true  //we do this because our MockData is sorted anyway by EmployeID
				}));
				this._oVSD.addSortItem(new sap.m.ViewSettingsItem({
					key: "FirstName",
					text: "First Name",
